...
//                             {/* Conditionally render Semester and Grade if available */}
//                             {marksheet.Semester && marksheet.Grade && (
//                                 <>
...
function TeacherView() {
    ...
    // Handle marksheet form data change
    ...
    // Handle marksheet form submission
    const handleMarksheetSubmit = async (e) => {
        ...
        try {
            ...
            alert(response.data.message);
            fetchStudentDetailsAndMarksheets(selectedSRN); // Refresh student details and marksheets after submission
        } catch (error) {
                    ...
                    <form onSubmit={handleMarksheetSubmit}>
                        ...
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="Parameter1"
                                value={marksheetData.Parameter1}
                                onChange={handleMarksheetChange} 
                                required 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="Parameter2"
                                value={marksheetData.Parameter2}
                                onChange={handleMarksheetChange} 
                                required 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="Parameter3"
                                value={marksheetData.Parameter3}
                                onChange={handleMarksheetChange} 
                                required 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="Parameter4"
                                value={marksheetData.Parameter4}
                                onChange={handleMarksheetChange} 
                                required 
                            />
                        </div>
